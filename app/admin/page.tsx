...
export default async function AdminPage() {
  ...
  return (
    <main
      id="main-content"
      className="brand-page-background min-h-screen py-12 md:py-16"
    >
      <div className="mx-auto w-full max-w-7xl px-6">
        <section className="brand-soft-panel mb-8 rounded-3xl p-8 md:p-10">
          <p className="text-sm uppercase tracking-[0.18em] text-purple-700/80">
            Admin Dashboard
          </p>
          ...
          <p className="mt-6 max-w-3xl text-gray-600">
            Upload and manage hero visuals and portfolio images in one place.
            Hero images now support separate folders for desktop and mobile.
          </p>
        </section>
        ...
        <section className="grid gap-8 lg:grid-cols-2">
          <article className="brand-soft-panel rounded-3xl p-6 md:p-8">
            ...
            <p className="mt-2 text-sm leading-relaxed text-gray-600">
              Upload large originals and the server will resize and compress
              them automatically for desktop or mobile.
            </p>
          ...
          <article className="brand-soft-panel rounded-3xl p-6 md:p-8">
            ...
            <p className="mt-2 text-sm leading-relaxed text-gray-600">
              Upload large originals and the server will optimize them before
              adding them to the portfolio grid.
            </p>
            <div className="brand-gradient-line my-6 h-px w-24" />
            <UploadFormPortfolio />
          </article>
        ...
        <section className="brand-soft-panel mt-8 rounded-3xl p-6 md:p-8">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-gray-600">
            Open dedicated pages to review current uploads and delete any image
            you no longer want.
          </p>
          <div className="brand-gradient-line my-6 h-px w-24" />
